...
export default function CompletedRepairs() {
  ...
  const filtered = repairs
    ...
    .sort((a, b) => {
      if (sortBy === 'newest') return new Date(b.actualCompletionDate || b.updatedAt) - new Date(a.actualCompletionDate || a.updatedAt);
      if (sortBy === 'oldest') return new Date(a.actualCompletionDate || a.updatedAt) - new Date(b.actualCompletionDate || b.updatedAt);
