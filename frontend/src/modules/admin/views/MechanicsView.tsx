...
import { getAllMechanics, createMechanic, updateMechanic, deleteMechanic, getAllBookings, assignMechanic } from '@/modules/admin/services/admin.service';
                    ...
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <button onClick={async () => {
                        const newWorkshopId = window.prompt(
                          ...
                          mechanic.workshopId ? String(workshopsList.findIndex(w => w._id === mechanic.workshopId) + 1) : ''
                        );
      ...
      <div className="bg-white shadow-sm rounded-lg overflow-hidden p-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="md:col-span-1 flex items-end">
            <button onClick={async () => {
              const bookingId = (document.getElementById('booking') as HTMLInputElement)?.value;
              const mechanicId = (document.getElementById('mechanic') as HTMLInputElement)?.value;
