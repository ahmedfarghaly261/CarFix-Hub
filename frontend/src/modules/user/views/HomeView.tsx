...
import BookAppointmentModal from '@/modules/user/components/BookAppointmentModal';
import { useAuth } from '@/context/AuthContext';
import { getAllAppointments, getUserCars } from '@/modules/user/services/user.service';
